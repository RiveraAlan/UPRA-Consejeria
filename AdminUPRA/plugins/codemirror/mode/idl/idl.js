...
(function(mod) {
  ...
  var builtinArray = [
    ...
    'cw_colorsel', 'cw_defroi', 'cw_field', 'cw_student_recordsel', 'cw_form',
    ...
    'define_msgblk', 'define_msgblk_from_student_record', 'defroi', 'defsysv',
    'delvar', 'dendro_plot', 'dendrogram', 'deriv', 'derivsig',
    'determ', 'device', 'dfpmin', 'diag_matrix', 'dialog_dbconnect',
    'dialog_message', 'dialog_pickstudent_record', 'dialog_printersetup',
    ...
    'f_cvf', 'f_pdf', 'factorial', 'fft', 'student_record_basename',
    'student_record_chmod', 'student_record_copy', 'student_record_delete', 'student_record_dirname',
    'student_record_expand_path', 'student_record_gunzip', 'student_record_gzip', 'student_record_info',
    'student_record_lines', 'student_record_link', 'student_record_mkdir', 'student_record_move',
    'student_record_poll_input', 'student_record_readlink', 'student_record_same',
    'student_record_search', 'student_record_tar', 'student_record_test', 'student_record_untar', 'student_record_unzip',
    'student_record_which', 'student_record_zip', 'student_recordpath', 'findgen', 'finite',
    ...
    'prostudent_record', 'prostudent_recordr', 'prostudent_records', 'project_vol', 'ps_show_fonts',
    ...
    'read_interstudent_record', 'read_jpeg', 'read_jpeg2000', 'read_mrsid', 'read_pict',
    ...
    'routine_student_recordpath', 'routine_info', 'rs_test', 's_test', 'save',
    ...
    'xbm_edit', 'xdisplaystudent_record', 'xdxf', 'xfont', 'xinteranimate',
