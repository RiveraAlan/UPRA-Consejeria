...
<div class="wrapper">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <a href="pages/mailbox/read-mail.html" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
          ...
          <div class="dropdown-divider"></div>
          <a href="pages/mailbox/mailbox.html" class="dropdown-item dropdown-footer">See All Messages</a>
        </div>
      </li>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="../../index3.html" class="brand-link">
      <img src="../../img/university.jpg" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Eliana Valenzuela Andrade</a>
        </div>
      </div>
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">ESTUDIANTES CCOM</h3>
                      ...
                      <td>
                          <ul class='list-inline'> <div align='center'>
                              <li class='list-inline-item'>
                                  <a title='UPRA' href='../tables/data.html'><img alt='Avatar' class='table-avatar' src='../../img/folder.svg' alt='UPRA' /></a>
                              </li></div>
                          </ul>
                      </td>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2020 <a href="#">CONSEJERIA-UPRA</a>.</strong> All rights reserved.
  </footer>
