...
@media screen and (max-width: 300px) {
  ...
  <form class="modal-content" action="/action_page.php">
    <div class="container">
      ...
      <p>Complete los siguientes campos para actualizar el expediente.</p>
      <hr>
      ...
      <label for="term"><b>Término del semestre</b></label>
      <input type="text" placeholder="Entre el término del semestre actual" name="term" required>
